...
def draw(window, map, player, blocks, objects, offset_x, offset_y):
    ...
    for x, y, image in map:
        ...
        if y < w_rect.top and y > w_rect.bottom:
            ...
            window.blit(image, (x - offset_x, y))
...
LEVEL_DICTIONARY = {
    ...
    2: ["assets", "world2", "Level_2.tmx"],
    3: ["assets", "world2", "Level_3.tmx"],
    4: ["assets", "world2", "Level_4.tmx"],
    5: ["assets", "world2", "Level_5.tmx"],
    6: ["assets", "world2", "Level_6.tmx"]
}
...
def main(window):
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.JOYBUTTONDOWN or event.type == pygame.JOYBUTTONUP:
                for ctrlr in controllers:
                    ...
                    if did_jump and player.jump_count < 2:
                        player.jump()
        ...
        window.fill((0,0,0))
        draw(window, level.background, player, level.get_blocks(), level.objects, offset_x, offset_y)
